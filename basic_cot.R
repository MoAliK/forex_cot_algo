...
notable_deviations <- cot[sigdev_jpylong_1,1] #dates of notable deviations for jpylong low long contracts
notable_deviations <- cot[sigdev_jpylong_2,1] #dates of notable deviations for jpylong high long contracts
...
notable_deviations <- cot[sigdev_jpyshort_1,1] #dates of notable deviations for jpyshort low short contracts
notable_deviations <- cot[sigdev_jpyshort_2,1] #dates of notable deviations for jpyshort high short contracts
